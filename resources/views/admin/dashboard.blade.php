        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Bem-vindo, {{ $user->name }}</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <a href="{{ route('vereadores.index') }}" class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 rounded-lg border border-gray-200 hover:border-gray-300 transition duration-150 ease-in-out">
                        <div>
                    ...
                    <div class="relative group bg-white p-6 rounded-lg border border-gray-200 opacity-50">
                        <div>
