    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">Nova Sessão</h1>
                    <p class="text-muted">Cadastre uma nova sessão da Câmara Municipal</p>
                </div>
            ...
            <form action="{{ route('admin.sessoes.store') }}" method="POST" enctype="multipart/form-data" id="sessaoForm">
                @csrf
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('legislatura') is-invalid @enderror" 
                                           id="legislatura" name="legislatura" value="{{ old('legislatura', date('Y')) }}" min="1" required>
                                    @error('legislatura')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sessao_legislativa') is-invalid @enderror" 
                                           id="sessao_legislativa" name="sessao_legislativa" value="{{ old('sessao_legislativa', 1) }}" min="1" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('local') is-invalid @enderror" 
                                           id="local" name="local" value="{{ old('local', 'Plenário da Câmara Municipal') }}" 
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('pauta') is-invalid @enderror" 
                                      ...
                                      placeholder="Descreva a pauta da sessão...">{{ old('pauta') }}</textarea>
                            @error('pauta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('ata') is-invalid @enderror" 
                                      ...
                                      placeholder="Registre a ata da sessão (pode ser preenchida posteriormente)...">{{ old('ata') }}</textarea>
                            @error('ata')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           value="{{ $vereador->id }}"
                                           {{ in_array($vereador->id, old('vereadores_presentes', [])) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('observacoes') is-invalid @enderror" 
                                      ...
                                      placeholder="Observações adicionais sobre a sessão...">{{ old('observacoes') }}</textarea>
                            @error('observacoes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
