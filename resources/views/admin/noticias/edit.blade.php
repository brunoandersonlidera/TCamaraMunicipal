...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeMediaSelector() {
        ...
        const quickUploadCategory = document.querySelector('#mediaSelectorModal #quickUploadCategory');
        ...
        // Definir categoria padrão para Notícias quando abrir a modal, se não houver seleção
        if (categoryFilter && !categoryFilter.value) {
            categoryFilter.value = 'noticias';
        }
        if (quickUploadCategory && !quickUploadCategory.value) {
            quickUploadCategory.value = 'noticias';
        }
